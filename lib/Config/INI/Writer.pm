...
$Config::INI::Writer::VERSION = '0.007';
...
default behavior is quite similar to that of L<Config::Tiny>, on which it is
based.
...
There are three reader methods, C<write_string>, C<write_file>, and
